using Application.Users.CredentialChecker;c
...
namespace WebAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(TokenService tokenService, ICredentialChecker credentialChecker)
        {
            ...
            var claims = new List<Claim>
    {
        ...
        new Claim(ClaimTypes.Role, identity.Role.ToString())
            ...
            // todo :save refreshToken in DB with userId
